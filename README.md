...
4. Save the file in a place you can find, like Downloads or Desktop.
5. If the file is in a `.zip` archive, extract it first.
6. Double-click the app file to start it.

If Windows asks for approval, choose **Run anyway** only if the file came from the release page above.

## ⚙️ Set Up Your Gemini Key
...
3. Follow the on-screen steps in the app.
4. Use the app to run and deploy your AI Studio project.

If the app opens in a browser, keep that window open while you use it.

## 🧩 What promptbuilder Does
...
3. Open the app
4. Load your AI Studio project
5. Run it locally
6. Deploy when you are ready
...
- app files — start the program
- support files — used by the app to run

Do not delete files unless you know what they do.

## 📄 How It Fits Your AI Studio App
